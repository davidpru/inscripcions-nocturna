  ...
  <div class="min-h-screen px-4 py-10">
    <div class="mx-auto max-w-4xl">
      ...
      <div class="mb-8 text-center">
        <h1 class="font-expanded mb-2 text-4xl font-bold text-slate-900">
          Nocturna Fredes-Paüls {{ edicion.anio }}
        </h1>
        <p class="text-lg text-slate-600">Consultar Inscripció</p>
      </div>
      ...
      <Card class="mx-4">
        <CardContent class="space-y-3 p-8">
          ...
          <form @submit.prevent="consultarInscripcion" class="space-y-6">
            ...
            <Field>
              <Label for="consulta_fecha">Data de Naixement *</Label>
              <Input
                id="consulta_fecha"
            ...
            <div class="flex justify-center pt-4">
              <Button type="submit" size="xl" :disabled="consultaForm.processing">
                {{ consultaForm.processing ? 'Consultant...' : 'Consultar Inscripció' }}
              </Button>
            </div>
          </form>
        </CardContent>
